...
class _NoteFormState extends State<NoteForm> {
  ...
  void _saveNote() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (widget.note == null) {
        final id = await dbHelper.insertNote(newNote);
        print('Inserted note with id: $id'); // Kiểm tra id trả về
      } else {
        final rowsAffected = await dbHelper.updateNote(newNote);
        print('Updated note, rows affected: $rowsAffected');
      }
